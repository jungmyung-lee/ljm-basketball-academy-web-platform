      ...
      <main>
        ...
        <section className="py-12 md:py-16 lg:py-20">
          <div className="container px-4 md:px-6">
            ...
            <div className="mx-auto mt-12 max-w-4xl rounded-xl border-2 border-primary/20 bg-accent/50 p-6 text-center md:p-8">
              <h2 className="text-xl font-semibold md:text-2xl">Want to Stay Updated?</h2>
              <p className="mt-3 text-base leading-relaxed text-muted-foreground md:text-lg">
                Make sure we have your current email address on file to receive announcements directly to your inbox.
              </p>
            </div>
          </div>
        </section>
